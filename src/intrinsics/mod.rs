...
pub(crate) fn codegen_intrinsic_call<'tcx>(
    ...
    intrinsic_match! {
        ...
        _ if intrinsic.starts_with("atomic_nand"), (v _ptr, c _src) {
            fx.tcx.sess.span_fatal(span, "atomic_nand is not yet supported by Cranelift.");
        };
        _ if intrinsic.starts_with("atomic_max"), (v _ptr, c _src) {
            fx.tcx.sess.span_fatal(span, "atomic_max is not yet supported by Cranelift.");
        };
        _ if intrinsic.starts_with("atomic_umax"), (v _ptr, c _src) {
            fx.tcx.sess.span_fatal(span, "atomic_umax is not yet supported by Cranelift.");
        };
        _ if intrinsic.starts_with("atomic_min"), (v _ptr, c _src) {
            fx.tcx.sess.span_fatal(span, "atomic_min is not yet supported by Cranelift.");
        };
        _ if intrinsic.starts_with("atomic_umin"), (v _ptr, c _src) {
            fx.tcx.sess.span_fatal(span, "atomic_umin is not yet supported by Cranelift.");
        };
